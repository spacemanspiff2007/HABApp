...
def test__ItemStateEvent() -> None:  # noqa: N802
...
# noinspection PyPep8Naming
def test__ItemCommandEvent() -> None:  # noqa: N802
...
# noinspection PyPep8Naming
def test__ItemAddedEvent1() -> None:  # noqa: N802
    event = get_event({
        'topic': 'openhab/items/TestString/added',
        'payload': '{"type":"String","name":"TestString","label":"MyLabel","category":"","tags":[],"groupNames":[]}',
        'type': 'ItemAddedEvent'}
    )
...
# noinspection PyPep8Naming
def test__ItemAddedEvent2() -> None:  # noqa: N802
    event = get_event({
    ...
    assert str(event) == (
        '<ItemAddedEvent name: TestColor_OFF, type: Color, tags: {tag2, test_tag}, groups: {TestGroup}>'
    )


# noinspection PyPep8Naming
def test__ItemUpdatedEvent() -> None:  # noqa: N802
    event = get_event({
...
# noinspection PyPep8Naming
def test__ItemRemovedEvent() -> None:  # noqa: N802
    event = get_event({
...
# noinspection PyPep8Naming
def test__ItemStatePredictedEvent() -> None:  # noqa: N802
...
# noinspection PyPep8Naming
def test__ItemStateChangedEvent2() -> None:  # noqa: N802
    utc_offset = datetime.datetime(2018, 6, 21).astimezone(None).strftime('%z')

    _in = {
        'topic': 'openhab/items/TestDateTimeTOGGLE/statechanged',
        'payload': f'{{"type":"DateTime","value":"2018-06-21T19:47:08.000{utc_offset}",'
                   f'"oldType":"DateTime","oldValue":"2017-06-20T17:46:07.000{utc_offset}"}}',
        'type': 'ItemStateChangedEvent'}
...
# noinspection PyPep8Naming
def test__GroupItemStateChangedEvent() -> None:  # noqa: N802
    d = {
...
# noinspection PyPep8Naming
def test__channel_ChannelTriggeredEvent() -> None:  # noqa: N802
    d = {
...
# noinspection PyPep8Naming
def test__channel_ChannelDescriptionChangedEvent() -> None:  # noqa: N802
    data = {
...
# noinspection PyPep8Naming
def test__thing_ThingStatusInfoEvent() -> None:  # noqa: N802
    data = {
    ...
    assert event.description == ''
    assert str(event) == (
        '<ThingStatusInfoEvent name: chromecast:chromecast:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa, '
    ...
    assert str(event) == (
        '<ThingStatusInfoEvent name: fsinternetradio:radio:fsRadioStation, '
        'status: OFFLINE, '
...
# noinspection PyPep8Naming
def test__thing_ThingStatusInfoChangedEvent() -> None:  # noqa: N802
    data = {
    ...
    assert str(event) == (
        '<ThingStatusInfoChangedEvent name: fsinternetradio:radio:fsRadioStation, '
        'status: OFFLINE, '
        'detail: COMMUNICATION_ERROR, '
        'description: "java.util.concurrent.ExecutionException: java.net.NoRouteToHostException", '
...
# noinspection PyPep8Naming
def test__thing_FirmwareStatusEvent() -> None:  # noqa: N802
    data = {
...
# noinspection PyPep8Naming
def test__thing_ThingAddedEvent() -> None:  # noqa: N802
    data = {
...
# noinspection PyPep8Naming
def test__thing_ThingRemovedEvent() -> None:  # noqa: N802
    data = {
...
def test__thing_ThingUpdatedEvent() -> None:  # noqa: N802
    ...
    data = {
        'type': 'ThingUpdatedEvent',
        'topic': 'openhab/things/my:thing:type:name/updated',
        'payload': '[{"channels":[{"uid":"my:thing:type:name:control","id":"control","channelTypeUID":"thing-type:control","itemType":"Rollershutter","kind":"STATE","label":"Control","description":"Device control (UP, DOWN, MY/STOP, closure 0-100%)","defaultTags":[],"properties":{},"configuration":{}},{"uid":"my:thing:type:name:rssi","id":"rssi","channelTypeUID":"thing-type:rssi","itemType":"Number","kind":"STATE","label":"RSSI Level","defaultTags":[],"properties":{},"configuration":{}}],"label":"Window Blinds Living Room","bridgeUID":"thing-type:bridge:home","configuration":{"url":"io://1303-5842-1226/3301069"},"properties":{"core:CommandLockLevelsState":"[]","core:NameState":"Wohnzimmer","core:ManufacturerSettingsState":"{}","core:RSSILevelState":"72.0","core:OpenClosedState":"open","core:DeploymentState":"100.0","core:StatusState":"available","core:MovingState":"false","core:Memorized1PositionState":"105.0","core:DiscreteRSSILevelState":"normal","core:TargetClosureState":"100.0"},"UID":"my:thing:type:name","thingTypeUID":"thing-type:awning","location":"Outer Space"},{"channels":[{"uid":"my:thing:type:name:control","id":"control","channelTypeUID":"thing-type:control","itemType":"Rollershutter","kind":"STATE","label":"Control","description":"Device control (UP, DOWN, MY/STOP, closure 0-100%)","defaultTags":[],"properties":{},"configuration":{}},{"uid":"my:thing:type:name:rssi","id":"rssi","channelTypeUID":"thing-type:rssi","itemType":"Number","kind":"STATE","label":"RSSI Level","defaultTags":[],"properties":{},"configuration":{}}],"label":"Window Blinds Living Room","bridgeUID":"thing-type:bridge:home","configuration":{"url":"io://1303-5842-1226/3301069"},"properties":{"core:CommandLockLevelsState":"[]","core:NameState":"Wohnzimmer","core:ManufacturerSettingsState":"{}","core:RSSILevelState":"72.0","core:OpenClosedState":"open","core:DeploymentState":"100.0","core:StatusState":"available","core:MovingState":"false","core:Memorized1PositionState":"105.0","core:DiscreteRSSILevelState":"normal","core:TargetClosureState":"100.0"},"UID":"my:thing:type:name","thingTypeUID":"thing-type:awning","location":"Somewhere"}]',  # noqa: E501
    }
...
# noinspection PyPep8Naming
def test__thing_ConfigStatusInfoEvent() -> None:  # noqa: N802
    data = {
...
def test__every_event_has_name(cls) -> None:
