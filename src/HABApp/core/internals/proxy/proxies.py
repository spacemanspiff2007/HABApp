...
def uses_get_item() -> Callable[[str], 'HABApp.core.internals.HINT_ITEM_OBJ']:
...
def setup_internals(
        ir: 'HABApp.core.internals.HINT_ITEM_REGISTRY', eb: 'HABApp.core.internals.HINT_EVENT_BUS', final=True):
    replacements = {
