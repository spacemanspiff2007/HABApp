...
from HABApp.core.items import HINT_TYPE_ITEM_OBJ, BaseValueItem
...
def test_create_item(item_cls: HINT_TYPE_ITEM_OBJ, default) -> None:
...
def test_get_create_item(item_cls: HINT_TYPE_ITEM_OBJ, default) -> None:
