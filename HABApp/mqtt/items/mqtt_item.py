...
from HABApp.core.items import Item, NumericItem
...
class MqttNumericItem(NumericItem):
    ...
    def publish(self, payload, qos=None, retain=None):
        ...
        :return: 0 if successful
        """
        return HABApp.mqtt.mqtt_interface.publish(self.name, payload, qos=qos, retain=retain)
