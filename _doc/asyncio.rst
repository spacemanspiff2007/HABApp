...
.. py:function:: self.async_http.get(url: str, params: typing.Optional[Mapping[str, str]] = None, **kwargs: typing.Any)
...
.. py:function:: self.async_http.post(url: str, params: typing.Optional[Mapping[str, str]] = None, data: typing.Any = None, json: typing.Any = None, **kwargs: typing.Any)
...
.. py:function:: self.async_http.put(url: str, params: typing.Optional[Mapping[str, str]] = None, data: typing.Any = None, json: typing.Any = None, **kwargs: typing.Any)
...
.. py:function:: self.async_http.delete(url: str, params: typing.Optional[Mapping[str, str]] = None, **kwargs: typing.Any)
